...
public class MongoInit {
    ...
    private static void initData() throws Exception {
        ...
        markDB.save(new MarkDocument(decks.get(1).getId(), users.get(0).getId(), 2));
        markDB.save(new MarkDocument(decks.get(1).getId(), users.get(1).getId(), 2));
        markDB.save(new MarkDocument(decks.get(1).getId(), users.get(2).getId(), 2));
        markDB.save(new MarkDocument(decks.get(1).getId(), users.get(3).getId(), 2));
        markDB.save(new MarkDocument(decks.get(2).getId(), users.get(0).getId(), 3));
        markDB.save(new MarkDocument(decks.get(2).getId(), users.get(1).getId(), 3));
        markDB.save(new MarkDocument(decks.get(2).getId(), users.get(2).getId(), 3));
        markDB.save(new MarkDocument(decks.get(2).getId(), users.get(3).getId(), 3));
        markDB.save(new MarkDocument(decks.get(3).getId(), users.get(0).getId(), 4));
        markDB.save(new MarkDocument(decks.get(3).getId(), users.get(1).getId(), 4));
        markDB.save(new MarkDocument(decks.get(3).getId(), users.get(2).getId(), 4));
        markDB.save(new MarkDocument(decks.get(3).getId(), users.get(3).getId(), 4));
        markDB.save(new MarkDocument(decks.get(4).getId(), users.get(0).getId(), 5));
        markDB.save(new MarkDocument(decks.get(4).getId(), users.get(1).getId(), 5));
        markDB.save(new MarkDocument(decks.get(4).getId(), users.get(2).getId(), 5));
        markDB.save(new MarkDocument(decks.get(4).getId(), users.get(3).getId(), 5));
        markDB.save(new MarkDocument(decks.get(5).getId(), users.get(0).getId(), 2));
        markDB.save(new MarkDocument(decks.get(5).getId(), users.get(1).getId(), 2));
        markDB.save(new MarkDocument(decks.get(5).getId(), users.get(2).getId(), 2));
        markDB.save(new MarkDocument(decks.get(6).getId(), users.get(0).getId(), 3));
        markDB.save(new MarkDocument(decks.get(6).getId(), users.get(1).getId(), 3));
        markDB.save(new MarkDocument(decks.get(6).getId(), users.get(2).getId(), 3));
        markDB.save(new MarkDocument(decks.get(7).getId(), users.get(0).getId(), 4));
        markDB.save(new MarkDocument(decks.get(7).getId(), users.get(1).getId(), 4));
        markDB.save(new MarkDocument(decks.get(7).getId(), users.get(2).getId(), 4));
        markDB.save(new MarkDocument(decks.get(8).getId(), users.get(0).getId(), 5));
        markDB.save(new MarkDocument(decks.get(8).getId(), users.get(1).getId(), 5));
        markDB.save(new MarkDocument(decks.get(8).getId(), users.get(2).getId(), 5));
        ...
        markDB.save(new MarkDocument(decks.get(10).getId(), users.get(1).getId(), 2));
        markDB.save(new MarkDocument(decks.get(10).getId(), users.get(2).getId(), 2));
        markDB.save(new MarkDocument(decks.get(11).getId(), users.get(1).getId(), 3));
        markDB.save(new MarkDocument(decks.get(11).getId(), users.get(2).getId(), 3));
        markDB.save(new MarkDocument(decks.get(12).getId(), users.get(1).getId(), 4));
        markDB.save(new MarkDocument(decks.get(12).getId(), users.get(2).getId(), 4));
        markDB.save(new MarkDocument(decks.get(13).getId(), users.get(1).getId(), 2));
        markDB.save(new MarkDocument(decks.get(14).getId(), users.get(1).getId(), 3));
        markDB.save(new MarkDocument(decks.get(15).getId(), users.get(1).getId(), 4));
        markDB.save(new MarkDocument(decks.get(16).getId(), users.get(1).getId(), 5));
